...
cmsRun fitterSusy.py onlyMC=True onlyId=True altSig=True &> log/mc_id_altSig.log &
cmsRun fitterSusy.py onlyMC=True onlyIso=True altSig=True &> log/mc_eta_altSig.log &
wait

./MCTemplates/fixParamFromMCFit.py &
wait
